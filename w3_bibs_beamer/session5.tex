...
\usepackage{apalike} % or \usepackage[super]{natbib} + \citep for superscripted intext citations
% redefine default apalike bst to avoid linebreaks in references
\setbeamertemplate{bibliography entry note}{}
\setbeamertemplate{bibliography entry location}{}
\setbeamertemplate{bibliography entry title}{}

\usepackage{notoccite} % references include all entries in the bib file, not only cited
...
\begin{frame}[fragile]{Gentle into to referencing}
