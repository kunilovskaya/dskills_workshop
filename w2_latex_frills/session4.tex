...
\newcounter{example}
\counterwithin*{example}{section} % avoid redefining theexample
...
\begin{itemize}
	...
	\fancyhead[RO,LE]{Thesis Title}	
		...
		\item a glossary to collect all abbreviations and acronyms \todo[inline]{This comment is generated by a todo[inline] command: Do I need a glossary?}
		\begin{lstlisting}
