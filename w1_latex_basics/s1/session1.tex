...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item[-] styles (\texttt{emnlp202lauren1.sty} for \verb|\usepackage[review]{emnlp2021}|) 
		\item[-] packages
...
\begin{tcolorbox}[width=\textwidth, colback={yellow!40!white}, title={}, colbacktitle=yellow!60!white, coltitle=black]
	\begin{itemize}
		...
		\item Tick Task 1 as done in the \href{https://docs.google.com/document/d/17ZBAQGBKIlO6JMwxz3LlghYq1sdsUjhHVXga46BK0kg/edit?usp=sharing}{Achievement Tracker}
	\end{itemize}
